...
class OldRedactor(forms.Textarea):
    toolbar = u'default' #'mini'
    class Media:
        js = (
            '/media/js/jquery.js',
            '/media/js/redactor_old/redactor.js',
            )
        css = {
            'all': ('/media/js/redactor_old/css/redactor.css',)
        }
    ...
    def __init__(self, attrs=None):
        ...
        super(OldRedactor,self).__init__(attrs)

    def render(self,name,value,attrs=None):
        rendered = super(OldRedactor,self).render(name, value, attrs)
...
class OldRedactorMini(OldRedactor):
    toolbar = u'mini'

class OldRedactorClassic(OldRedactor):
    toolbar = u'classic'

class Redactor(forms.Textarea):
    buttons = u'''\'html', '|', 'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
    ...
    def render(self,name,value,attrs=None):
        ...
        </script>''' % (name,self.buttons))

class RedactorMini(Redactor):
    buttons = u'''\'formatting', '|', 'bold', 'italic', 'deleted', '|', 'unorderedlist', 'orderedlist', 'outdent', 'indent', '|',
    'link\''''
